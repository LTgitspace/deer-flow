...
This document lists common issues encountered during UniDeer smoke testing and how to resolve them.
...
3. Or stop UniDeer services first:
   ```bash
   make stop
   ```
...
#### Clean Up All UniDeer-Related Containers and Images
```bash
make docker-stop

...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 UniDeer, an open source super agent. With built-in and custom skills, UniDeer helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of UniDeer. With customized skills,\nUniDeer can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  inputBox: {
    ...
    voiceInputStart:
      "Dictate with voice. UniDeer receives only transcribed text; audio is handled by your browser or system speech service.",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. UniDeer is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but UniDeer could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "UniDeer's official website",
    githubTooltip: "UniDeer on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "UniDeer on GitHub",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your UniDeer bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your UniDeer bot.",
      feishu: "Feishu and Lark messages through your UniDeer app.",
      dingtalk: "DingTalk Stream Push messages through your UniDeer bot.",
      wechat: "WeChat iLink messages through your UniDeer bot.",
      wecom: "WeCom messages through your UniDeer AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to UniDeer",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate UniDeer faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how UniDeer looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "UniDeer automatically learns from your conversations in the background. These memories help UniDeer understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to UniDeer from outside the browser.",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        authStarted:
          "Authorization page opened. UniDeer will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; UniDeer keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, UniDeer only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. UniDeer keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. UniDeer will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; UniDeer checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    skills: {
      title: "Agent Skills",
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of UniDeer.",
    ...
    notification: {
      title: "Notification",
      description:
        "UniDeer only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so UniDeer cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. UniDeer stores only your email, never your password.",
    ...
    adminSetupRequiredDescription:
      "UniDeer needs an administrator account before new regular accounts can be created.",

...
In Docker deployments, this path is bind-mounted from the host so that thread data persists across container restarts. Set `UNI_DEER_ROOT` to the absolute path of your unideer repository root to ensure the correct host path is used.

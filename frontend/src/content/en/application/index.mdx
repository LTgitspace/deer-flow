---
title: UniDeer App
description: UniDeer App is the reference implementation of what a production UniDeer experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  UniDeer App is a complete Super Agent application built on top of UniDeer
...
UniDeer App is the reference implementation of what a production UniDeer experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The UniDeer App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, UniDeer Harness                               |
| Reverse proxy     | nginx                                                                |

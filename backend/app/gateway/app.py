...
# ColoredLevelFormatter auto-disables ANSI colors when stderr is not a TTY
# (e.g. logs piped to a file), so file logs stay plain while the console
# shows INFO in green.
_console_handler = logging.StreamHandler()
_console_handler.setFormatter(ColoredLevelFormatter(DEFAULT_LOG_FORMAT, datefmt=DEFAULT_LOG_DATE_FORMAT))

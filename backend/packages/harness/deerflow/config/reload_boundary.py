...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    "vision_bridge": ("VisionBridgeMiddleware is wired into the middleware chain at agent build time; changing vision_model or enabled requires a Gateway restart."),

...
1. Start UniDeer locally using any working development setup you already use.
   ...
   If you already have UniDeer running locally, you can reuse that existing setup.

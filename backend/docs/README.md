...
This directory contains detailed documentation for the UniDeer backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs UniDeerClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to UniDeer?** Start with [SETUP.md](SETUP.md) for quick installation
